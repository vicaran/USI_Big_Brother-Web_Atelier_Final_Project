...
function drawAllCanvases() {
    ...
    lightCanvas.width = window.innerWidth/5;
    lightCanvas.height = window.innerHeight / 20;
    ...
    var reDrawCanvas = function() {
        posCanvas.width = window.innerWidth/2;
        posCanvas.height = window.innerHeight/10;
