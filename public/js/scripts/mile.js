...
'<div id="navbar">' +
        ...
        '<div class="text-input" id="block-input1">'+
            ...
            'From: '+
            '</p>'+
            '<input type="text" name="From" placeholder="Enter date in format "mm/dd/yyyy hh:mm:ss"" id="db-from1"/>'+
            '<p>'+
            '<br>'+
            'To: '+
            '</p>'+
        ...
        '<div class="text-input" id="block-input2">'+
            ...
            'From: '+
            '</p>'+
            '<input type="text" name="From" placeholder="Enter date in format "mm/dd/yyyy hh:mm:ss"" id="db-from2"/>'+
            '<p>'+
            '<br>'+
            'To: '+
            '</p>'+
            '<input type="text" name="To" placeholder="Enter date in format "mm/dd/yyyy hh:mm:ss"" id="db-to2"/>'+
